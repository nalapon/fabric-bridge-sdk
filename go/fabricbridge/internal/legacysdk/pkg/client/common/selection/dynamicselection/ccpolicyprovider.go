...
import (
	...
	"github.com/kolokium/fabric-bridge-go/fabricbridge/internal/legacysdk/internal/github.com/hyperledger/fabric/core/common/ccprovider"
...
func (dp *ccPolicyProvider) GetChaincodePolicy(chaincodeID string) (*common.SignaturePolicyEnvelope, error) {
	...
	ccData, err = ccprovider.UnmarshalChaincodeData(response)
	if err != nil {
