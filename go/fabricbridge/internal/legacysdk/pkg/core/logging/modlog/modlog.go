...
import (
	...
	"github.com/kolokium/fabric-bridge-go/fabricbridge/internal/legacysdk/pkg/core/logging/metadata"
)
...
func hasLoggerFnPrefix(pkgPath string, fnName string) bool {
	const (
		loggingAPIPath = "github.com/kolokium/fabric-bridge-go/fabricbridge/internal/legacysdk/pkg/core/logging/"
		loggingAPIPkg  = "api" // Go < 1.12
		modlogFnPrefix = "modlog.(*Log)."
		loggingPath    = "github.com/kolokium/fabric-bridge-go/fabricbridge/internal/legacysdk/pkg/common/"
		loggingPkg     = "logging"
		logBridgePath  = "github.com/kolokium/fabric-bridge-go/fabricbridge/internal/legacysdk/internal/github.com/hyperledger/fabric-ca/sdkpatch/logbridge"
