...
import (
	...
	"github.com/kolokium/fabric-bridge-go/fabricbridge/internal/legacysdk/internal/github.com/hyperledger/fabric/sdkpatch/cryptosuitebridge"
...
func CreateUtcTimestamp() *timestamppb.Timestamp {
	...
	return &(timestamppb.Timestamp{Seconds: secs, Nanos: nanos})
}
